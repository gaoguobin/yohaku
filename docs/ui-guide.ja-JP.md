...
詳細ページに更新または再インストールの操作が表示される場合は、それを使って
から新しいスレッドを開始します。

詳細ページが古いバージョンのままで更新操作も表示されない場合は、Goal Shaper
をアンインストールします。必要であれば `Yohaku` マーケットプレイスを削除して
追加し直し、Goal Shaper を再インストールして Codex App を再起動し、新しいス
レッドを開始します。

Yohaku マーケットプレイスを削除すると、そのマーケットプレイスからインストー
ルしたすべてのプラグインに影響します。
