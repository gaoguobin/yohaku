...
| UI update check | After a newer release exists, restart Codex App and open the installed Goal Shaper details page. | If the details page shows the newer version, start a new thread. If it stays old, use the CLI update flow from `UPDATE.md`. |
